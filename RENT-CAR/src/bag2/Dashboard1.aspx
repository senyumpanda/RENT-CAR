<%@ Page Title="" Language="C#" MasterPageFile="~/src/bag2/Bagian_2.Master" AutoEventWireup="true" CodeBehind="Dashboard1.aspx.cs" Inherits="RENT_CAR.src.bag2.Dashboard" %>

<asp:Content ID="Dashboard1" ContentPlaceHolderID="Master2" runat="server">
    ...
    <div class="row">
        ...
        <div class="sisi-kiri col-lg-2 pt-3 text-black text-center">
            ...
            <div class="list ml-3">
                <h4 class="font-weight-bold mt-5 aktif">
        ...
        <div class="sisi-kanan col-lg-9 p-5 pt-5" style="background-color: #fff;">
            <div class="bungkus-table" style="">
                <asp:Panel ID="data_pembukuan" runat="server"></asp:Panel>
            </div>
        </div>
        <%-- AKHIR BAG KANAN --%>
    </div>
