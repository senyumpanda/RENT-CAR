<%@ Page Title="" Language="C#" MasterPageFile="~/src/bag2/Bagian_2.Master" AutoEventWireup="true" CodeBehind="Tambah_Mobil.aspx.cs" Inherits="RENT_CAR.src.bag2.Tambah_Mobil" %>
                ...
                <div class="bungkus-luar row mx-auto" style="background-color: white;">
                    ...
                    <div class="pil-tombol w-75 mx-auto d-flex justify-content-around">
                        ...
                        <div class="tambah_data">
                            <asp:Button Text="Tambah Data" ID="tbl_tambah_data" CssClass="btn btn-success w-100" runat="server" OnClick="tbl_tambah_data_Click" />
                        </div>
                        <%-- AKHIR TAMBAH DATA --%>
                    </div>
